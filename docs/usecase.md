...
This document contains the visual **Use-Case** and **Process Flow** diagrams for **KSP DRISTI**, representing the interaction boundaries and the execution sequence of the platform.

---

## 🗺️ 1. Complete System Use-Case Diagram

This diagram details the interaction between system users and the platform's core functional modules.
...
graph LR
    ...
    subgraph Stage1Container ["STAGE 1: INPUT NORMALIZATION"]
        Stage1["TEXT NORMALIZER<br>• Transcribes speech (Web Speech API)<br>• Converts Hinglish & local shorthand<br>• Standardizes station terms (e.g., ps to police station)"]:::seqBlue
    end
